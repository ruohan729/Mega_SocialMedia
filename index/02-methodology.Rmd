...
```{r GoogleTrends3, out.width="200px", fig.align="center",out.extra="angle = 0, scale=2.1", fig.cap="Coca-Cola Teams Ensemble Framework", echo=FALSE}
include_graphics(path = "figure/coke_ensemble_framework.png")
```

## Scholle System Integration {.unnumbered}
