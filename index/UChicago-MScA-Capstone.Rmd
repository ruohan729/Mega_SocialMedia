...
```{r differencing, out.width="200px", fig.align="center", fig.cap="differenced social media data", echo=FALSE}
...
```{r pca, out.width="200px", fig.align="center", fig.cap="Principal Component Analysis"}
include_graphics(path = "figure/pca.jpg", echo=FALSE)
```
...
---
nocite: | 
  @angel2000, @angel2001, @angel2002a, @Olah2015
...
